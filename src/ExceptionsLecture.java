...
//        } catch(Exception e){ //<- e is a variable name
//            e.printStackTrace(); //<-- returns the string of the exception
//        }
//        System.out.println("Will this run???"); //<-- yes the catch catches that error then continues to the rest of the code.
...
//
//        addTwoAndTwo(3, 1); // will only throw an exception at runtime line 68


        // checked exceptions

//        makeConnection(); //line 94
