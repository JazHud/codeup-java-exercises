...
//<-- once Pet is implemented you have to have its methods be called below (beCute)
    ...
    // to keep this the same even through method manipulation like with the argumentativeOrnithologist method in bird test.txt will not work since it is final::: final can also be used on the Parrot and no more extensions can be made of Parrot:: final on methods can not be overridden either;
